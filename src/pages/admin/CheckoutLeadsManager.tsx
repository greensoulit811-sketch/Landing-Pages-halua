...
import { Search, Trash2, Eye, Phone, CheckCircle, UserCheck, X, FileText, Truck } from 'lucide-react';
          ...
          <div className="bg-card border border-border w-full max-w-lg my-8 p-6 md:p-8 rounded-lg shadow-lg">
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-2 pt-2 border-t border-border mt-2">
                <Button size="sm" variant="secondary" onClick={() => printInvoice(viewingLead)} className="flex-1 gap-1.5">
                  <FileText className="h-3.5 w-3.5" /> Print Invoice
                </Button>
                <Button size="sm" variant="secondary" onClick={() => printCourierSlip(viewingLead)} className="flex-1 gap-1.5">

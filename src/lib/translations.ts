...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Why Choose Us
    'why.label': 'The লাভ ফর এভার হালুয়া Difference',
    ...
    'product.authentic': '100% Authentic - Verified by লাভ ফর এভার হালুয়া',
    'product.free_delivery': 'Free delivery across Malaysia on orders over BDT 150',
  ...
  bn: {
    ...
    // Why Choose Us
    'why.label': 'লাভ ফর এভার হালুয়া এর বিশেষত্ব',
    ...
    'product.authentic': '১০০% অরিজিনাল - লাভ ফর এভার হালুয়া যাচাইকৃত',
